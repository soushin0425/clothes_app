...
class ClothingShoes extends StatelessWidget {
  const ClothingShoes({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<ClothingListModel>(
        create: (_) => ClothingListModel()..fetchShoesList(),
        child: Consumer<ClothingListModel>(
          builder: ((context, model, child) {
            final List<Clothing>? clothing = model.shoes;
